...
export class ExamNextJsClient {
    ...
    protected processFoodItemsAll(response: Response): Promise<FoodItem[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    foodItemsAll2(id: string): Promise<FoodItemDetailModel[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processFoodItemsAll2(_response);
        });
    }

    protected processFoodItemsAll2(response: Response): Promise<FoodItemDetailModel[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getRestaurantDetail(id: string): Promise<RestaurantFoodDetailModel[]> {
    ...
    protected processGetRestaurantDetail(response: Response): Promise<RestaurantFoodDetailModel[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as RestaurantFoodDetailModel[];
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RestaurantFoodDetailModel[]>(null as any);
    }
...
export interface RestaurantFoodDetailModel {
    id?: string | undefined;
    foodItemId?: string | undefined;
