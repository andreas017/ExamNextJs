...
namespace ExamNextJsBackend.Services
{
    public class AutomaticMigrationService
    {
        ...
        {
            var id = "01GY78CAD512ZDVZ9B1RVHJZQB";
        ...
        {
            var exist = await _scopeManager.FindByNameAsync("api:webapp", cancellationToken);
            if (exist != null)
            {
                return;
            }
        ...
        private async Task<string?> CreateCmsApp(CancellationToken cancellationToken)
        {
            ...
            var o = await _appManager.CreateAsync(new OpenIddictApplicationDescriptor
            {
                ...
                Permissions =
                {
                    ...
                    Permissions.Prefixes.Scope + "api:webapp"
                },
